...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorId != usuarioID {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("só pode editar sua própria publicação"))
		return
	}
...
func UsuarioPublicacao(w http.ResponseWriter, r *http.Request) {
	parametros := mux.Vars(r)
...
// Aumenta o numero de curtidas na publicação
...
// Diminui o numero de curtidas na publicação
